...
boost::ut::suite atomic_spin_lock_test = []() {
  ...
  "hal::soft::atomic_spin_lock"_test = []() {
    "::lock & ::unlock"_test = []() {
      // Setup
      hal::soft::atomic_spin_lock test_subject;
  ...
  "hal::soft::timed_atomic_spin_lock"_test = []() {
    "::lock"_test = []() {
      // Setup
      using namespace std::chrono_literals;
      hal::mock::steady_clock mock_steady_clock;
      hal::soft::timed_atomic_spin_lock test_subject(mock_steady_clock);
